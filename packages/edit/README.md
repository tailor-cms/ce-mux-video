...
Authoring component for the **MUX Video** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-mux-video-edit
```
...
```ts
import { Edit } from '@tailor-cms/ce-mux-video-edit';
```
